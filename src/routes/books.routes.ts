...
/**
 * GET /books  (v1 — mounted at /api/v1/books)
 ...
 *
 * There is no `type` here, and sending one is a 400 rather than being ignored —
 * see books.v2.routes.ts, which takes it. This endpoint's behaviour is frozen:
